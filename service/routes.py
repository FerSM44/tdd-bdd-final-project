...
#Create a Flask route that responds to the GET method for the endpoint /products/<product_id>
@app.route("/products/<int:product_id>", methods=["GET"])
#Create a function called get_products(product_id) to hold the implementation
#Call the Product.find() method which will return a product with the given product_id
def get_products(product_id):
    """ Recover a Product this endpoint will recover a Product based on ID """
    app.logger.info("Searching %s", product_id)
    ...
    app.logger.info("Returning %s", product.name)
...
def delete_products(product_id):
    """ Delete a Product this endpoint will delete a Product based the id specified in the path """
